...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final MotorControllerGroup m_leftMotors =
      new MotorControllerGroup(Constants.controllers.leftFrontSpark, Constants.controllers.leftRearSpark);

  // The motors on the right side of the drive.
  private final MotorControllerGroup m_rightMotors =
      new MotorControllerGroup(Constants.controllers.rightFrontSpark, Constants.controllers.rightRearSpark);
